...
func (x *SessionServiceRequest) Reset() {
	*x = SessionServiceRequest{}
...
func (x *SessionServiceRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SessionServiceRequest) ProtoMessage() {}

func (x *SessionServiceRequest) ProtoReflect() protoreflect.Message {
	mi := &file_pb_session_proto_msgTypes[0]
...
// Deprecated: Use SessionServiceRequest.ProtoReflect.Descriptor instead.
func (*SessionServiceRequest) Descriptor() ([]byte, []int) {
	return file_pb_session_proto_rawDescGZIP(), []int{0}
}

func (x *SessionServiceRequest) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *SessionServiceResponse) Reset() {
	*x = SessionServiceResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *SessionServiceResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SessionServiceResponse) ProtoMessage() {}

func (x *SessionServiceResponse) ProtoReflect() protoreflect.Message {
	mi := &file_pb_session_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SessionServiceResponse.ProtoReflect.Descriptor instead.
func (*SessionServiceResponse) Descriptor() ([]byte, []int) {
	return file_pb_session_proto_rawDescGZIP(), []int{1}
}

func (x *SessionServiceResponse) GetSessionId() string {
	if x != nil {
		return x.SessionId
	}
	return ""
...
var file_pb_session_proto_rawDesc = []byte{
	...
	,
...
var file_pb_session_proto_goTypes = []interface{}{
	(*SessionServiceRequest)(nil),  // 0: pb.SessionServiceRequest
	(*SessionServiceResponse)(nil), // 1: pb.SessionServiceResponse
}
var file_pb_session_proto_depIdxs = []int32{
	0, // 0: pb.SessionService.GetSessionId:input_type -> pb.SessionServiceRequest
	1, // 1: pb.SessionService.GetSessionId:output_type -> pb.SessionServiceResponse
...
func file_pb_session_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_pb_session_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SessionServiceRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_pb_session_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SessionServiceResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
